...
| 5 | Who should I pick? | Strength / Agility / Intelligence / Universal; primary attribute → HP, attack speed, armour, magic resistance | Attributes are gold's exchange rate | §1: Try a hero | Sven, Phantom Assassin, Zeus (one per attribute) / attribute items |
| 6 | What am I for in this team? | Positions 1–5, core vs. support, power spikes. Discussion: the community disagrees on a beginner's first role (most say support; some say mid) | How experience is distributed | §3 intro: heroes vs. creeps | Crystal Maiden (5), Juggernaut (1) / Arcane Boots |
...
| 8 | When should I not engage? | Stuns, status effects, dispels, spell immunity, evasion | BKB = buying five seconds of certainty | §2: Stuns and control, status effects; §4: BKB, Glimmer Cape, evasion | Sand King (Burrowstrike) / Black King Bar, Glimmer Cape |
| 9 | Where did he go? | Warding, fog, detecting invisibility, minimap habits, pings | Information is the cheapest and the most expensive resource | §2: Map vision; §3: Detecting invisibility | Vengeful Spirit / Observer & Sentry Wards (proper) |
| 10 | Towers or heroes? | Towers, barracks, Roshan and the Aegis, outposts, runes, TP defence | Mid-game: converting a lead into map | §2: Mid-game farming, Roshan and the Aegis | Enigma (Black Hole) / Blink Dagger |
| 11 | Who goes first? | Initiation and counter-initiation, positioning, buyback, high ground; **Captains Mode drafting primer (prerequisite for A4)** | Time: whose curve peaks later | §2: Teamfight initiation; §4: All Pick matches | Tidehunter / Refresher Orb |
